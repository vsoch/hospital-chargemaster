...
url = 'https://www.ynhh.org/patients-visitors/billing-insurance/pricing.aspx'
...
for entry in soup.find_all('a', href=True):
    ...
    if '.csv' in download_url:  
        ...
        os.system('wget -O "%s" "%s" --no-check-certificate' % (output_file, download_url))
