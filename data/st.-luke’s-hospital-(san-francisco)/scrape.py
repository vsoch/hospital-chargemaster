...
url ='https://www.sutterhealth.org/for-patients/health-care-costs-and-charges'
...
prefix = "https://www.sutterhealth.org"
...
for entry in soup.find_all('a', href=True):
    # This file has a matching xlsx, but don't want to repeat data
