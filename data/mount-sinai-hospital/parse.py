...
for result in results:
    ...
    if filename.endswith('xlsx'):
        ...
        if charge_type == "drg":
            ...
            # Doesn't have a header, but has item / charge
            content = pandas.read_excel(filename)
            content.columns = ['DESCRIPTION', 'PRICE']
            for row in content.iterrows():
                idx = df.shape[0] + 1
...
# Note: the descriptions have what looks like another encoding.
