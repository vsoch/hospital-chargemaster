...
url ='https://www.pennmedicine.org/for-patients-and-visitors/patient-information/insurance-and-billing/financial-transparency/financial-transparency-for-the-hospital-of-the-university-of-pennsylvania'
...
prefix = "https://www.pennmedicine.org"
...
for entry in soup.find_all('a', href=True):
    ...
    if '.ashx' in download_url:  
        ...
        filename = filename.replace('.ashx','.csv')
